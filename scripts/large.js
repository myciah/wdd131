...
const filtered = temples.filter(e => e.area >= 90000)
...
for (let i = 0; i < filtered.length; i++) {
  ...
  for (let j = 0; j < temp.length; j++) {
    document.getElementById("largeTemples" + i + j).innerHTML = temp[j];
     document.getElementById("largeTemples" + i + "4").src = temp[4]
     document.getElementById("largeTemples" + i + "4").alt = temp[0]
  }
}
