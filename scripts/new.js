...
button.addEventListener('click', () => {
 ...
 const filtered = temples.filter(e => e.dedicated[0] >= 2000)
 ...
 for (let i = 0; i < filtered.length; i++) {
   ...
   for (let j = 0; j < temp.length; j++) {
      document.getElementById("newTemples" + i + j).innerHTML = temp[j];
      document.getElementById("newTemples" + i + "4").src = temp[4]
      document.getElementById("newTemples" + i + "4").alt = temp[0]
   }
 }
